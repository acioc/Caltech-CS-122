...
public class FromClause {
     ...
     *         IO issue occurs.
     */
    public Schema prepare(TableManager tableManager) throws IOException {
        ...
        case SELECT_SUBQUERY:
            ...
            result = derivedTable.computeSchema(tableManager);
        ...
        case JOIN_EXPR:
            ...
            Schema leftSchema = leftChild.prepare(tableManager);
            Schema rightSchema = rightChild.prepare(tableManager);
